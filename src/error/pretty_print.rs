...
pub fn pretty_print(
    ...
    queue!(stdout, RESET_STYLE, Print("\n"))?;

    // print note message if it is needed.
    // The message for this is generated by calling the crate::error::Error::err_note_str.
...
pub fn plain_print(
    ...
    // print note message if it is needed.
    // The message for this is generated by calling the crate::error::Error::err_notestr.
    if let Some(vesti_note) = vesti_error.err_note_str() {
