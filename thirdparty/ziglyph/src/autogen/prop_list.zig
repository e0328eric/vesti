...
pub fn isIdsBinaryOperator(cp: u21) bool {
    if (cp < 0x2ff0 or cp > 0x31ef) return false;
...
pub fn isIdsUnaryOperator(cp: u21) bool {
    if (cp < 0x2ffe or cp > 0x2fff) return false;
...
pub fn isOtherIdContinue(cp: u21) bool {
    if (cp < 0xb7 or cp > 0xff65) return false;
...
pub fn isIdCompatMathContinue(cp: u21) bool {
    if (cp < 0xb2 or cp > 0x1d7c3) return false;
...
pub fn isIdCompatMathStart(cp: u21) bool {
    if (cp < 0x2202 or cp > 0x1d7c3) return false;
...
pub fn isModifierCombiningMark(cp: u21) bool {
    if (cp < 0x654 or cp > 0x8f3) return false;
