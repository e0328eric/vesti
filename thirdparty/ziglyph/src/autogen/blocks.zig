...
pub fn isTodhri(cp: u21) bool {
    if (cp < 0x105c0 or cp > 0x105ff) return false;

    return switch (cp) {
        0x105c0...0x105ff => true,
        else => false,
    };
}
...
pub fn isGaray(cp: u21) bool {
    if (cp < 0x10d40 or cp > 0x10d8f) return false;

    return switch (cp) {
        0x10d40...0x10d8f => true,
        else => false,
    };
}
...
pub fn isTuluTigalari(cp: u21) bool {
    if (cp < 0x11380 or cp > 0x113ff) return false;

    return switch (cp) {
        0x11380...0x113ff => true,
        else => false,
    };
}
...
pub fn isMyanmarExtendedC(cp: u21) bool {
    if (cp < 0x116d0 or cp > 0x116ff) return false;

    return switch (cp) {
        0x116d0...0x116ff => true,
        else => false,
    };
}
...
pub fn isSunuwar(cp: u21) bool {
    if (cp < 0x11bc0 or cp > 0x11bff) return false;

    return switch (cp) {
        0x11bc0...0x11bff => true,
        else => false,
    };
}
...
pub fn isEgyptianHieroglyphsExtendedA(cp: u21) bool {
    if (cp < 0x13460 or cp > 0x143ff) return false;

    return switch (cp) {
        0x13460...0x143ff => true,
        else => false,
    };
}
...
pub fn isGurungKhema(cp: u21) bool {
    if (cp < 0x16100 or cp > 0x1613f) return false;

    return switch (cp) {
        0x16100...0x1613f => true,
        else => false,
    };
}
...
pub fn isKiratRai(cp: u21) bool {
    if (cp < 0x16d40 or cp > 0x16d7f) return false;

    return switch (cp) {
        0x16d40...0x16d7f => true,
        else => false,
    };
}
...
pub fn isSymbolsForLegacyComputingSupplement(cp: u21) bool {
    if (cp < 0x1cc00 or cp > 0x1cebf) return false;
...
pub fn isOlOnal(cp: u21) bool {
    if (cp < 0x1e5d0 or cp > 0x1e5ff) return false;

    return switch (cp) {
        0x1e5d0...0x1e5ff => true,
        else => false,
    };
}
...
pub fn isCjkUnifiedIdeographsExtensionI(cp: u21) bool {
    if (cp < 0x2ebf0 or cp > 0x2ee5f) return false;

    return switch (cp) {
        0x2ebf0...0x2ee5f => true,
        else => false,
    };
}
